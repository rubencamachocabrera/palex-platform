...
interface Notificacion {
  tipo: "oportunidad_inactiva" | "visita_borrador" | "fase_retrasada" | "proyecto_por_vencer" | "tarea_retrasada" | "mencion" | "recordatorio" | "hardware_garantia" | "hardware_mantenimiento"
  id: string
  titulo: string
  href: string
  mensaje: string
