/**
 * Iconos SVG inline de Palex Medical.
 * Sin dependencias externas — compatibles con SSR y PWA.
 * Todos aceptan className y size (por defecto 20).
 */
