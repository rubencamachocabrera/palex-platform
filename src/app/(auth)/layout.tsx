    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center bg-white rounded-2xl px-5 py-3 shadow-lg shadow-black/10">
            <Image src="/logo-palex.png" alt="InLab Palex Medical" width={148} height={48} priority />
          </div>
        </div>
