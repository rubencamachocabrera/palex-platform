...
export default function ModuleError({ error, reset }: Props) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-6 text-center">
      ...
      <p className="font-semibold text-gray-800 mb-1">Error al cargar esta seccion</p>
      ...
      <div className="flex gap-3">
        ...
        <a href="/dashboard" className="text-sm font-medium px-4 py-2 rounded-xl border border-gray-200 text-gray-600 hover:bg-gray-50 transition-colors">
          Dashboard
        </a>
      </div>
    </div>
