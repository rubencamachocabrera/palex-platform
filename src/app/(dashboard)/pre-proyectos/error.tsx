...
export default function PreProyectosError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center px-4">
      ...
      <div>
        <h2 className="text-base font-semibold text-gray-800">Error al cargar pre-proyectos</h2>
