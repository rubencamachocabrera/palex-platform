...
export default function PreProyectoError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center px-4">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">No se pudo obtener la información de este pre-proyecto.</p>
      ...
      <div className="flex gap-2">
        ...
        <button
          onClick={() => router.push("/pre-proyectos")}
