...
interface HardwareCatalogo { tipo: string; marca: string; modelo: string }
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-sm text-gray-500">Añade hardware desde el catálogo en Admin</p>
        </div>
      ) : (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <div className="px-5 py-3 border-t border-gray-100 text-xs text-gray-400 flex items-center justify-between">
            <span>{unidades.length} unidad{unidades.length !== 1 ? "es" : ""}</span>
          </div>
        </div>
      )}
    </div>
